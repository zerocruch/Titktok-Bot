...
__all__ = [
    'SpeechTokenKeyFiles', 'DISPID_SRCEPhraseStart',
    'DISPID_SPPs_NewEnum', 'DISPID_SDKGetBinaryValue', 'SVF_None',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPS_RESERVED3', 'SRTEmulated',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPERetainedStreamOffset',
    ...
    'SREPrivate', 'SAFTADPCM_22kHzStereo', 'DISPID_SVSLastBookmarkId',
    'SITooLoud', 'DISPID_SREmulateRecognition', 'DISPID_SOTCategory',
    'SREAdaptation', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechFileStream',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_PRIVATE15', 'SPEI_MIN_TTS',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_RESERVED4', 'SPPHRASE',
    'ISpeechLexiconPronunciations', 'ISpeechObjectTokenCategory',
    'DISPID_SBSSeek', 'DISPID_SLWPronunciations',
    'DISPID_SpeechPhraseReplacements', 'SPEI_FALSE_RECOGNITION',
    'STCInprocServer', 'DISPID_SFSClose', 'SPLOADOPTIONS',
    'DISPIDSPTSI_SelectionOffset', '_SPAUDIOSTATE',
    'SPEI_SR_BOOKMARK', 'SPSModifier', 'SpPhoneConverter',
    'DISPID_SRGState', 'SPSSuppressWord', 'SPAR_High',
    'DISPID_SRCERecognition', 'SVP_16', 'DISPID_SpeechAudio',
    'SP_VISEME_13', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCEPropertyStringChange', 'SITooSlow',
    'DISPID_SRProfile', 'SPPS_RESERVED4', 'SPSFunction',
    'SGSDisabled', 'eLEXTYPE_PRIVATE7', 'SRTSMLTimeout',
    'SDTPronunciation', 'DISPID_SPEAudioSizeTime',
    'SVEEndInputStream', 'ISpNotifySource', 'SGRSTTEpsilon',
    'SAFT48kHz16BitMono', 'SVP_21', 'SPPARTOFSPEECH', 'ISpShortcut',
    'ISpeechMMSysAudio', 'DISPID_SVSLastBookmark', 'SPWT_LEXICAL',
    'DISPID_SRCRequestedUIType', 'SPWT_DISPLAY', 'SP_VISEME_2',
    'DISPID_SGRsCount', 'SWTAdded', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRsAdd', 'DISPID_SpeechPhoneConverter',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRSClsidEngine',
    'SVESentenceBoundary', 'SINone', 'SPBINARYGRAMMAR',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSkip',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechPhraseRule',
    'SpTextSelectionInformation', 'SpeechAudioProperties',
    'DISPID_SBSRead', 'SAFT11kHz8BitMono',
    'SpeechPropertyHighConfidenceThreshold', 'SASPause',
    'DISPID_SPAsCount', 'SPAS_PAUSE', 'SDTAlternates', 'SPWORD',
    'DISPID_SRCERecognitionForOtherContext', 'SpNullPhoneConverter',
    'STSF_CommonAppData', 'DISPID_SRCResume',
    'DISPID_SVGetAudioInputs', 'SAFT8kHz8BitMono',
    'DISPID_SWFEFormatTag', 'SPSInterjection', 'SRTAutopause',
    'SVSFDefault', 'SpeechVoiceEvents', 'SP_VISEME_6',
    'SpeechCategoryRecognizers', 'DISPID_SOTGetStorageFileName',
    'SVP_2', 'ISpStreamFormat', 'SAFT48kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'SPEVENTENUM', 'SRERecoOtherContext',
    'ISpeechPhraseRule', 'DISPID_SOTRemove', 'SpeechGrammarState',
    'SECFIgnoreCase', 'SPEI_WORD_BOUNDARY', 'SpSharedRecoContext',
    'SpResourceManager', 'SAFT44kHz16BitStereo', 'SRAImport',
    'SREAllEvents', 'eLEXTYPE_APP', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPAStartElementInResult', 'SRADynamic',
    'DISPID_SRGDictationUnload', 'SpInProcRecoContext',
    'SVSFParseAutodetect', 'SDKLCurrentConfig', 'SPAR_Medium',
    'SpCustomStream', 'DISPID_SRGetFormat',
    'DISPIDSPTSI_SelectionLength', 'SpStream',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechLexicon',
    'ISpResourceManager', 'SPDKL_DefaultLocation',
    'SAFT16kHz8BitStereo', 'SPEI_TTS_BOOKMARK', 'DISPID_SRGReset',
    'DISPID_SRCEBookmark', 'SGSEnabled', 'eLEXTYPE_PRIVATE18',
    'DISPID_SGRSRule', 'SpeechGrammarTagUnlimitedDictation',
    'SPAUDIOSTATUS', 'ISpeechPhraseInfo', 'DISPID_SDKSetStringValue',
    'SPEI_PHRASE_START', 'eLEXTYPE_USER', 'ISpNotifyTranslator',
    'SpeechVoiceSkipTypeSentence', 'SVP_4', 'SPGS_ENABLED',
    'DISPID_SPRuleId', 'DISPID_SVSLastResult', 'SPVPRIORITY',
    'SPLEXICONTYPE', 'SPSMF_UPS', 'SRSEDone', 'SVP_0', 'SRSInactive',
    ...
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SRCState',
    'SAFTADPCM_22kHzMono', 'DISPID_SADefaultFormat',
    'DISPID_SRGCmdSetRuleState', 'SPEVENTSOURCEINFO',
    'SECHighConfidence', 'DISPID_SRIsUISupported', 'SPAUDIOOPTIONS',
    'SPPS_RESERVED1', 'DISPID_SWFEBlockAlign', 'SASStop',
    'DISPID_SRGCmdSetRuleIdState', 'ISpLexicon', 'ISpPhrase',
    'SpeechCategoryVoices', 'DISPID_SPRulesCount',
    'SpeechStreamSeekPositionType', 'SP_VISEME_1', 'SP_VISEME_3',
    ...
    'DISPID_SVVolume', 'SPEI_ADAPTATION', 'SSFMOpenForRead',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SOTDisplayUI',
    'ISpRecoGrammar', 'SPFM_OPEN_READWRITE',
    'DISPID_SLAddPronunciation', 'SP_VISEME_0',
    'ISpeechRecognizerStatus', 'SpeechPartOfSpeech',
    'ISpeechLexiconWords', 'ISpAudio', 'DISPID_SRRTOffsetFromStart',
    'ISpGrammarBuilder', 'SpeechTokenKeyUI', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTGetAttribute', 'SDTReplacement',
    'DISPID_SLGetPronunciations', 'SRERecognition',
    'SGRSTTTextBuffer', 'ISpeechPhraseReplacement', 'SPEI_MAX_SR',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPRuleFirstElement',
    'SpStreamFormatConverter', 'SVP_9', 'SVSFParseSapi',
    'DISPID_SpeechPhraseInfo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechLexiconWord', 'DISPID_SPRuleParent',
    'ISpeechMemoryStream', 'SAFT12kHz16BitMono',
    'DISPID_SLGenerationId', 'SPAS_CLOSED', 'SpeechDataKeyLocation',
    'DISPID_SDKEnumKeys', 'DISPID_SVSCurrentStreamNumber',
    'SAFT32kHz8BitStereo', 'DISPID_SRRAudio', 'DISPID_SLWsCount',
    'SRAExport', 'DISPID_SABIEventBias', 'DISPID_SpeechPhraseElement',
    'SpeechPropertyLowConfidenceThreshold', 'SVPNormal',
    'SAFT24kHz8BitStereo', 'ISpSerializeState', 'DISPID_SRRecognizer',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRSTWeight',
    'DISPID_SpeechObjectTokens', 'SPDATAKEYLOCATION', 'SPAR_Unknown',
    'ISpRecoContext2', 'DISPID_SLGetGenerationChange', 'SPSHT_OTHER',
    'SPWT_PRONUNCIATION', 'SRSEIsSpeaking',
    'ISpeechPhraseReplacements', 'SpWaveFormatEx',
    'SpeechWordPronounceable', 'DISPID_SVPriority',
    'ISpeechGrammarRule', 'STSF_AppData', 'SPXRO_SML',
    'DISPID_SGRsItem', 'DISPID_SGRSAddWordTransition',
    'SPEI_SOUND_START', 'DISPID_SABufferNotifySize',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpRecognizer3', 'SVP_11',
    'SpeechGrammarTagWildcard', 'DISPID_SOTId', 'SITooQuiet',
    'SAFTGSM610_44kHzMono', 'SPSHT_NotOverriden', 'IEnumString',
    'SP_VISEME_16', 'SINoSignal', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_9', 'DISPID_SGRAttributes', 'SPINTERFERENCE_NONE',
    'SPFM_CREATE', 'SPRS_INACTIVE', 'DISPID_SVAudioOutputStream',
    'ISpeechObjectTokens', 'DISPID_SVGetVoices', 'SGLexical',
    'SFTSREngine', 'SDTAll', 'SPBOOKMARKOPTIONS', 'DISPID_SGRName',
    'DISPID_SpeechObjectToken', 'SVSFIsNotXML', 'SECFEmulateResult',
    'DISPID_SpeechPhraseRules',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREPhraseStart',
    'SpMMAudioIn', 'SPCT_COMMAND', 'DISPID_SGRSTs_NewEnum',
    'ISequentialStream', 'SpUnCompressedLexicon', 'SDTLexicalForm',
    'SPDKL_LocalMachine', 'SRSActive', 'SPFM_NUM_MODES',
    'SPFM_OPEN_READONLY', 'SVSFParseMask', 'SAFT12kHz16BitStereo',
    'DISPID_SLWs_NewEnum', 'ISpeechRecoResult2', 'SPAR_Low',
    'SRATopLevel', 'SPCT_DICTATION', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechVoiceEvent', 'STSF_FlagCreate',
    'DISPID_SPCIdToPhone', 'SPPHRASEELEMENT',
    'DISPID_SASCurrentSeekPosition', 'SREPropertyNumChange',
    'eLEXTYPE_PRIVATE9', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCBookmark', 'SPWORDTYPE', 'DISPID_SASState',
    'DISPID_SPRDisplayAttributes', 'ISpeechPhoneConverter',
    'DISPID_SGRClear', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVPOver', 'SITooFast', 'eLEXTYPE_RESERVED10', 'SPSHT_EMAIL',
    'DISPID_SPEAudioSizeBytes', 'SSTTDictation', 'SPWF_SRENGINE',
    'ISpeechBaseStream', 'SVPAlert', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPRText', 'SpeechRecoProfileProperties',
    'SRSActiveAlways', 'DISPID_SVSVisemeId',
    'DISPID_SpeechLexiconPronunciation', 'SAFT11kHz8BitStereo',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRGetRecognizers',
    'SPEI_RESERVED3', 'SPPHRASEPROPERTY', 'eLEXTYPE_LETTERTOSOUND',
    'eLEXTYPE_PRIVATE5', 'SP_VISEME_20', 'DISPID_SASetState',
    'DISPID_SGRsFindRule', 'SAFT22kHz16BitStereo',
    'SAFT24kHz16BitMono', 'DISPID_SVSPhonemeId',
    'DISPID_SVSRunningState', 'SREHypothesis', 'SECFDefault',
    'SpFileStream', 'SPRST_NUM_STATES', 'ISpStream',
    'SDKLLocalMachine', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRRGetXMLErrorInfo', 'SDA_Consume_Leading_Spaces',
    'SVP_5', 'SPPS_Verb', 'SVEPrivate', 'DISPID_SPEPronunciation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SGRSTTDictation',
    'DISPID_SpeechGrammarRuleState', 'SpeechFormatType',
    'ISpPhraseAlt', 'DISPID_SPAsItem', 'DISPID_SVDisplayUI',
    'SpeechPropertyResourceUsage', 'DISPID_SRGCmdLoadFromResource',
    'ISpStreamFormatConverter', 'SPEI_REQUEST_UI', 'SPPS_Function',
    'SPAS_RUN', 'SPSEMANTICFORMAT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPEI_SR_PRIVATE',
    'SAFT32kHz8BitMono', 'SPPS_Noncontent', 'eLEXTYPE_PRIVATE6',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechRecoResult', 'SVP_10',
    'SPSHORTCUTPAIR', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SpeechRecognizer', '_RemotableHandle',
    'DISPID_SPARecoResult', 'DISPID_SRRAlternates',
    'SAFTCCITT_ALaw_11kHzMono', 'SPTEXTSELECTIONINFO',
    'SpeechRecoEvents', 'SGDSInactive', 'SAFT12kHz8BitStereo',
    'DISPID_SPEDisplayAttributes', 'SPPS_Noun', 'SAFTDefault',
    'DISPID_SLWLangId', 'ISpeechPhraseAlternates',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTsCount',
    'ISpeechAudio', 'SpeechRunState', 'SGPronounciation',
    'ISpRecoContext', 'DISPID_SRState', 'SP_VISEME_19',
    'DISPID_SPCPhoneToId', 'SPRECOGNIZERSTATUS', 'ISpeechDataKey',
    'SVP_8', 'DISPID_SGRAddResource', 'DISPID_SRCEEndStream',
    'DISPIDSPTSI_ActiveLength', 'SAFTCCITT_uLaw_11kHzMono',
    'SDA_One_Trailing_Space', 'SpeechRecognitionType',
    'DISPID_SPERetainedSizeBytes', 'SPXRO_Alternates_SML',
    'SPINTERFERENCE_NOISE', 'SAFT48kHz8BitMono', 'SVSFPersistXML',
    'DISPID_SPCLangId', 'eLEXTYPE_RESERVED9', 'SPSHORTCUTTYPE',
    'SPWORDLIST', 'SPEI_TTS_PRIVATE', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVGetProfiles', 'ISpeechAudioStatus',
    'SECNormalConfidence', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechGrammarRules', 'SASClosed',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechLexiconWord',
    'tagSPTEXTSELECTIONINFO', '_ISpeechVoiceEvents',
    'DISPID_SAVolume', 'DISPID_SVRate', 'DISPID_SPPId',
    'ISpPhoneticAlphabetConverter', 'ISpMMSysAudio', 'SRESoundStart',
    'DISPID_SVAlertBoundary', 'SSFMCreateForWrite',
    'SPRECORESULTTIMES', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SFSOpen', 'ISpeechPhraseRules', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechGrammarRule', 'DISPID_SVEAudioLevel',
    'SSSPTRelativeToStart', 'SVSFParseSsml', 'DISPID_SLPType',
    'DISPID_SVSInputWordLength', 'SPGS_DISABLED',
    'SpeechVisemeFeature', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechInterference', 'SDTProperty', 'SASRun', 'SVSFIsFilename',
    'SPCT_SUB_COMMAND', 'ISpDataKey', 'SpShortcut',
    'SpeechLexiconType', 'DISPID_SRCEHypothesis', 'DISPID_SPPValue',
    'DISPID_SPPFirstElement', 'SPRULESTATE', 'DISPID_SABufferInfo',
    'SWPKnownWordPronounceable', 'DISPID_SVEventInterests',
    'DISPID_SPRFirstElement', 'Speech_StreamPos_Asap',
    'DISPID_SRRTimes', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechPhraseProperties',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechXMLRecoResult', 'SPSNoun',
    'DISPIDSPRG', 'SpeechVisemeType', 'SDTDisplayText', 'SPAS_STOP',
    'DISPID_SGRSTNextState', 'DISPID_SVSInputSentencePosition',
    'ISpeechGrammarRules', 'SRAORetainAudio', 'DISPID_SPPsItem',
    'SPSHT_Unknown', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_PRIVATE14', 'DISPID_SGRsCommitAndSave',
    'SpPhraseInfoBuilder', 'eLEXTYPE_PRIVATE19', 'SVP_12',
    ...
    'DISPID_SCSBaseStream', 'ISpPhoneticAlphabetSelection',
    'SpeechDiscardType', 'SPINTERFERENCE_NOSIGNAL', 'ISpObjectToken',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCCmdMaxAlternates',
    'ISpeechRecognizer', 'SpSharedRecognizer',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPPChildren', 'Speech_Max_Word_Length',
    'SPPS_Interjection', 'SPEI_SR_RETAINEDAUDIO', 'SREStreamStart',
    'DISPID_SLPSymbolic', 'SVSFlagsAsync',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_VISEME', 'DISPID_SPIElements',
    'DISPID_SPELexicalForm', 'SRADefaultToActive',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRCRecognizer',
    'DISPID_SpeechCustomStream', 'SPRST_INACTIVE', 'SVF_Emphasis',
    'DISPID_SRAudioInput', 'SPEI_RESERVED5', 'SSSPTRelativeToEnd',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_PRIVATE12', 'SVEPhoneme',
    'DISPID_SRCEStartStream', 'SVSFNLPSpeakPunc', 'SPVOICESTATUS',
    'SPSEMANTICERRORINFO', 'SpeechAudioState', 'SVEAllEvents',
    'DISPID_SPIReplacements', 'DISPID_SWFEChannels',
    'DISPID_SRGCmdLoadFromObject', 'ISpeechRecoResultDispatch',
    'DISPID_SLPPhoneIds', 'SREAudioLevel',
    'DISPID_SPPEngineConfidence', 'DISPID_SRGDictationSetState',
    'ISpXMLRecoResult', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPRulesItem', 'DISPID_SVIsUISupported',
    'SAFT8kHz8BitStereo', 'DISPID_SPRNumberOfElements',
    'DISPID_SVStatus', 'DISPID_SRCEAdaptation',
    'DISPID_SDKSetLongValue', 'SPEI_RESERVED2', 'SDKLDefaultLocation',
    'DISPID_SRCEFalseRecognition', 'tagSTATSTG',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVESentenceBoundary',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSTsItem',
    'SECFIgnoreKanaType', 'SECFNoSpecialChars', 'SVP_3',
    'ISpObjectTokenCategory', 'ISpProperties', 'SpeechAllElements',
    'SpeechGrammarRuleStateTransitionType', 'SPCT_SUB_DICTATION',
    'DISPID_SRGIsPronounceable', 'DISPID_SPILanguageId',
    'SVSFNLPMask', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTPropertyValue', 'DISPID_SAFType', 'WAVEFORMATEX',
    'ISpeechFileStream', 'SpeechCategoryAudioOut', 'SBOPause',
    'SRTStandard', 'ISpEventSource', 'DISPID_SOTs_NewEnum',
    'DISPID_SGRs_NewEnum', 'SpeechRuleAttributes',
    'SPPS_SuppressWord', 'SPAUDIOSTATE', 'DISPID_SDKGetStringValue',
    'DISPID_SDKCreateKey', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRGDictationLoad', 'DISPID_SPRsItem', 'SPBO_AHEAD',
    'DISPID_SRCEInterference', 'ISpeechPhraseAlternate',
    'Speech_Default_Weight', 'DISPID_SPAPhraseInfo',
    'DISPID_SPRuleChildren', 'SpeechPropertyComplexResponseSpeed',
    'SpeechDictationTopicSpelling', 'tagSPPROPERTYINFO',
    'DISPID_SVEBookmark', 'SpeechDisplayAttributes', 'SVP_13',
    'SLTApp', 'SSSPTRelativeToCurrentPosition', 'SP_VISEME_10',
    'SP_VISEME_11', 'SGRSTTWord', 'SPEI_RESERVED1', 'SSTTWildcard',
    'DISPID_SGRSTType', 'SPWORDPRONUNCIATIONLIST', 'SPEI_HYPOTHESIS',
    'SPEI_PHONEME', 'SREBookmark', 'DISPID_SPRuleEngineConfidence',
    'SLODynamic', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPPNumberOfElements', 'SAFTADPCM_8kHzStereo',
    'SPEI_MIN_SR', 'UINT_PTR', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechLexicon', 'SPINTERFERENCE_TOOLOUD',
    'SpeechGrammarTagDictation', 'SpPhoneticAlphabetConverter',
    'SDTAudio', 'DISPID_SASNonBlockingIO', 'SpeechLoadOption',
    'DISPID_SVResume', 'DISPID_SPRules_NewEnum',
    'DISPID_SDKGetlongValue', 'SVP_20', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCPause', 'SPPS_NotOverriden', 'DISPID_SGRId',
    'SRERequestUI', 'SPEI_START_INPUT_STREAM', 'SPBO_TIME_UNITS',
    'DISPID_SDKDeleteValue', 'DISPID_SVGetAudioOutputs', 'SPAO_NONE',
    'SRAONone', 'DISPID_SMSADeviceId', 'eLEXTYPE_USER_SHORTCUT',
    'IInternetSecurityManager', 'SpMMAudioOut', 'SAFT44kHz16BitMono',
    'SPWF_INPUT', 'DISPID_SpeechMemoryStream', 'SAFT22kHz16BitMono',
    'SPAUDIOBUFFERINFO', 'SPRECOCONTEXTSTATUS',
    'SAFT32kHz16BitStereo', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPEs_NewEnum', 'SRAInterpreter', 'SPEI_SOUND_END',
    'DISPID_SPEsCount', 'SVP_6', 'eLEXTYPE_PRIVATE1',
    'SAFTGSM610_8kHzMono', 'SPWAVEFORMATTYPE', 'SAFTADPCM_44kHzMono',
    'ISpRecoCategory', 'DISPID_SRCSetAdaptationData', 'SpObjectToken',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCAudioInInterferenceStatus',
    'SP_VISEME_4', 'SAFT24kHz16BitStereo', 'DISPID_SOTCreateInstance',
    'DISPID_SABIBufferSize', 'SpeechTokenValueCLSID',
    'DISPID_SpeechPhraseAlternate', 'SPPROPERTYINFO',
    'DISPID_SRGSetWordSequenceData', 'ISpeechRecoResultTimes',
    'DISPID_SRRGetXMLResult', 'DISPID_SPRuleName',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SAEventHandle',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechLexiconPronunciation',
    'SAFTGSM610_22kHzMono', 'eLEXTYPE_PRIVATE11',
    'SpNotifyTranslator', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT44kHz8BitStereo', 'SpeechCategoryAppLexicons', 'SFTInput',
    'DISPID_SGRSTText', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SLWType',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SBSWrite', 'SVEViseme',
    'SVP_15', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_SR_AUDIO_LEVEL',
    'SPEI_VOICE_CHANGE', 'SLOStatic', 'SVEWordBoundary',
    'SVF_Stressed', 'SP_VISEME_17', 'DISPID_SOTsItem',
    'eWORDTYPE_DELETED', 'DISPID_SRSSupportedLanguages', 'SPEVENT',
    'DISPID_SVEViseme', 'SPPHRASEREPLACEMENT', 'eLEXTYPE_PRIVATE17',
    'SAFTADPCM_11kHzStereo', 'ISpeechRecoContext',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCESoundStart',
    'SPEI_UNDEFINED', 'SAFTNoAssignedFormat', 'SpeechCategoryAudioIn',
    'SPSUnknown', 'ISpNotifySink', 'SAFT11kHz16BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_19',
    'eLEXTYPE_PRIVATE10', 'SPCONTEXTSTATE', 'DISPID_SPPName',
    'DISPID_SPIRule', 'SAFTNonStandardFormat', 'SAFT24kHz8BitMono',
    'SPBO_PAUSE', 'SpeechGrammarWordType', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRRAudioFormat',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPISaveToMemory', 'DISPID_SGRsDynamic',
    'SECLowConfidence', 'SAFTText', 'DISPID_SRGRecoContext',
    'SSFMCreate', 'DISPID_SPIAudioSizeTime', 'ISpEventSink',
    'DISPID_SDKOpenKey', 'DISPID_SOTSetId', 'SPDKL_CurrentConfig',
    'IInternetSecurityMgrSite', 'SPDKL_CurrentUser', 'ISpRecoResult',
    'SPCS_DISABLED', 'SPINTERFERENCE_TOOFAST',
    'ISpeechGrammarRuleState', 'SPPS_LMA', 'SVEStartInputStream',
    'DISPID_SGRsCommit', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVP_18',
    'SPLO_DYNAMIC', 'SpLexicon', 'DISPID_SLGetWords',
    'DISPID_SRSetPropertyString', 'DISPID_SPEAudioTimeOffset',
    'SVSFVoiceMask', 'DISPID_SpeechRecoContext', 'SVP_1', 'LONG_PTR',
    'SPEI_INTERFERENCE', 'SpeechRecoContextState', 'SGDSActive',
    'SAFT16kHz16BitStereo', 'DISPID_SPPConfidence',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPPsCount', 'SVP_7', 'SPLO_STATIC',
    'DISPID_SRCRetainedAudio', 'SRARoot', 'DISPID_SRRTLength',
    'ISpeechVoiceStatus', 'SVEBookmark', 'SAFT22kHz8BitMono',
    'DISPID_SGRInitialState', 'DISPID_SpeechWaveFormatEx',
    'SAFT22kHz8BitStereo', 'SpeechAudioFormatGUIDWave',
    'SRCS_Enabled', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE16',
    'SAFT16kHz16BitMono', 'DISPID_SpeechAudioFormat',
    'SpCompressedLexicon', 'Speech_Max_Pron_Length',
    'SGDSActiveUserDelimited', 'SREPropertyStringChange',
    'SpeechVoicePriority', 'SPRULE', 'DISPID_SRCEEnginePrivate',
    'SPVPRI_ALERT', 'SDTRule', 'DISPID_SPIEngineId',
    'DISPID_SOTRemoveStorageFileName', 'SGRSTTWildcard',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechRecoResultTimes',
    'ISpeechCustomStream', 'DISPID_SMSAMMHandle',
    'ISpeechRecoGrammar', 'SPINTERFERENCE', 'SpVoice',
    'SpeechStreamFileMode', 'DISPID_SRGSetTextSelection',
    'SpInprocRecognizer', 'SPFM_CREATE_ALWAYS',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPWORDPRONUNCIATION', 'SP_VISEME_5',
    'DISPID_SGRSTransitions', 'DISPID_SpeechObjectTokenCategory',
    'SPPHRASERULE', 'SDA_Two_Trailing_Spaces', 'SP_VISEME_18',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechLexiconWords',
    'DISPID_SRSAudioStatus', 'DISPID_SVSpeak',
    'ISpeechGrammarRuleStateTransition', 'SpeechVoiceSpeakFlags',
    'SSTTTextBuffer', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSMF_SAPI_PROPERTIES', 'SpeechUserTraining', 'SPEI_MAX_TTS',
    'DISPID_SLWWord', 'DISPID_SPIGetText', 'DISPID_SPIAudioSizeBytes',
    'SBONone', 'DISPID_SOTMatchesAttributes', 'SDA_No_Trailing_Space',
    'SpeechPropertyAdaptationOn', 'SPGS_EXCLUSIVE', 'SPFILEMODE',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVSLastStreamNumberQueued',
    'SP_VISEME_21', 'DISPID_SpeechAudioBufferInfo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPEActualConfidence',
    'DISPID_SGRSAddSpecialTransition', 'SINoise', 'DISPID_SRIsShared',
    'SPRS_ACTIVE', 'SREInterference', 'IStream',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPRuleConfidence',
    'SpeechTokenShellFolder', 'SGLexicalNoSpecialChars',
    'ISpeechTextSelectionInformation', 'DISPID_SLPLangId',
    'DISPID_SPIStartTime', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SLWsItem', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTCId',
    'DISPID_SLRemovePronunciation', 'DISPID_SBSFormat',
    'DISPID_SDKEnumValues', 'SpeechWordType', 'ISpRecognizer',
    'SGRSTTRule', 'DISPID_SpeechRecoResult2', 'SVEAudioLevel',
    'DISPID_SpeechVoice', 'ISpVoice', 'DISPID_SVEWord', 'SPVISEMES',
    'SRTReSent', 'DISPID_SRRDiscardResultInfo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPEEngineConfidence',
    'SpeechBookmarkOptions', 'SAFT32kHz16BitMono',
    'SSFMOpenReadWrite', 'SPSNotOverriden', 'eLEXTYPE_RESERVED6',
    'DISPID_SRRRecoContext', 'SpeechSpecialTransitionType',
    'DISPID_SRStatus', 'SAFT16kHz8BitMono', 'DISPID_SRGRules',
    ...
    'SPVPRI_OVER', 'SPVPRI_NORMAL', 'DISPID_SRSCurrentStreamPosition',
    'SpeechCategoryPhoneConverters', 'SAFT11kHz16BitMono',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCVoicePurgeEvent',
    'eLEXTYPE_RESERVED8', 'DISPID_SVAudioOutput', 'DISPID_SMSALineId',
    'SPGRAMMARWORDTYPE', 'DISPID_SLPs_NewEnum',
    'SPEI_START_SR_STREAM', 'DISPID_SRRSetTextFeedback',
    'SpeechEngineConfidence', 'DISPID_SPIAudioStreamPosition',
    'SAFTCCITT_uLaw_22kHzMono', 'SpAudioFormat', 'DISPID_SPPParent',
    'SWPUnknownWordPronounceable', 'STCAll', 'STCInprocHandler',
    'DISPID_SRRSaveToMemory', 'ISpObjectWithToken',
    'DISPID_SWFEExtraData', 'SpeechRecognizerState',
    'DISPID_SLPsCount', 'SpMMAudioEnum', 'DISPID_SVPause',
    'STCLocalServer', 'SPPS_RESERVED2',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechObjectToken',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPGRAMMARSTATE',
    'SP_VISEME_15', 'DISPID_SASFreeBufferSpace', 'eLEXTYPE_PRIVATE20',
    'SRESoundEnd', 'DISPID_SGRSTPropertyId', 'SPBO_NONE',
    'SpeechAddRemoveWord', 'DISPID_SpeechPhraseElements',
    'DISPID_SOTCSetId', 'ISpPhoneConverter', 'DISPID_SRCERequestUI',
    'SpeechEmulationCompareFlags', 'ISpeechAudioBufferInfo',
    'DISPID_SRRSpeakAudio', 'eWORDTYPE_ADDED', 'SRSInactiveWithPurge',
    'SAFT8kHz16BitMono', 'DISPID_SVSpeakCompleteEvent',
    'SDKLCurrentUser', 'SAFTADPCM_11kHzMono', 'SVSFIsXML',
    'DISPID_SRRPhraseInfo', 'SPSVerb', 'eLEXTYPE_PRIVATE3',
    'DISPID_SMSGetData', 'SVEVoiceChange', 'ISpeechPhraseProperties',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRAddState', 'SPCT_SLEEP',
    'SPCATEGORYTYPE', '__MIDL_IWinTypes_0009', 'ISpRecoGrammar2',
    'DISPID_SABIMinNotification', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SVEStreamStart', 'ISpeechAudioFormat', 'DISPID_SPACommit',
    'ISpeechResourceLoader', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_RESERVED6', 'ISpeechWaveFormatEx', 'DISPID_SpeechDataKey',
    'SpeechEngineProperties', 'SpeechRegistryUserRoot', 'SP_VISEME_7',
    'SP_VISEME_12', 'DISPID_SGRSTRule', 'SGSExclusive',
    'SpeechTokenContext', 'DISPID_SRGCommit', 'SAFT44kHz8BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE4',
    'SpMemoryStream', 'SAFT8kHz16BitStereo',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCEventInterests',
    'SPAO_RETAIN_AUDIO', 'SPRST_ACTIVE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_END_SR_STREAM',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_MORPHOLOGY', 'SPRECOSTATE',
    'SGDisplay', 'SPEI_TTS_AUDIO_LEVEL', 'SPSLMA',
    'ISpeechXMLRecoResult', 'SPSERIALIZEDRESULT',
    'DISPID_SOTIsUISupported', 'SVP_14', 'SGDSActiveWithAutoPause',
    'SREStateChange', 'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_8',
    'SRTExtendableParse', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRCVoice', 'IEnumSpObjectTokens', 'SpObjectTokenCategory',
    'SREStreamEnd', 'SRCS_Disabled', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SOTDataKey', 'DISPIDSPTSI',
    'DISPID_SRCEPropertyNumberChange', 'SpeechRuleState',
    'SREFalseRecognition', 'eLEXTYPE_PRIVATE8', 'DISPID_SVVoice',
    'DISPID_SAFGuid', 'DISPID_SRDisplayUI', 'SPPS_Modifier',
    'ISpeechVoice', 'SVSFUnusedFlags', 'DISPID_SpeechRecoResult',
    'SAFT48kHz8BitStereo', 'SVP_17', 'DISPID_SLPsItem',
    'DISPID_SMSSetData', 'DISPID_SPEDisplayText',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SVSInputSentenceLength', 'SpeechMicTraining',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRSTsCount',
    'DISPID_SpeechAudioStatus', 'DISPID_SVEStreamEnd',
    'DISPID_SVEPhoneme', 'SPEI_RECOGNITION', 'ISpeechPhraseElement',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVEVoiceChange',
    'STSF_LocalAppData', 'SpeechCategoryRecoProfiles', 'SP_VISEME_14',
    'DISPID_SPIGrammarId', 'DISPID_SGRSAddRuleTransition',
    'STCRemoteServer', 'SLTUser', 'DISPID_SDKDeleteKey',
    'SPPS_Unknown', 'ISpeechPhraseProperty', 'DISPID_SAStatus',
    'SECFIgnoreWidth'
]

_check_version('1.1.14', 1626520826.718778)
